                ...
                (column, index) =>
                    column.forEach(element => {
                        const newMatrix = new MatrixDomain({
                            validators: {},
                            ...{
                                frequencyRisk: savedFrequency.find(e => e.id_frequency_risk === element.frequencyRisk.id_frequency_risk || (e.description === element.frequencyRisk.description && e.weight === element.frequencyRisk.weight)),
                                heatMap: heatMap.id,
                                impactRisk: savedImpact.find(e => e.id_impact_risk === element.impactRisk.id_impact_risk || (e.description === element.impactRisk.description && e.weight === element.impactRisk.weight)),
                                riskLevel: savedRiskLevel.find(e => e.id_risk_level === element.riskLevel.id_risk_level || (e.name === element.riskLevel.name && e.color === element.riskLevel.color)),
